                        ...
                        if x['rprod_id'] == y.id:
                            for z in old_prod:
                                if x['id'] == z.id:
                                    ...
                                    z.disc = x ['disc']
                                    z.total = x['total']
                    if x['id'] == 0 and x['prod_id'] and x['unit_id'] and x['order'] and int(x['order']) > 0 and x['price'] and x['price'] > 0:
                        ...
                        if x['rjasa_id'] == y.id:
                            for z in old_jasa:
                                if x['id'] == z.id:
                                    ...
                                    z.disc = x ['disc']
                                    z.total = x['total']
                    if x['id'] == 0 and x['sup_id'] and x['jasa_id'] and x['unit_id'] and x['order'] and int(x['order']) > 0 and x['price'] and x['price'] > 0:
