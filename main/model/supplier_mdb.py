...
class SupplierMdb(db.Model):
    ...
    sup_telp1 = db.Column(db.Integer)
    sup_telp2 = db.Column(db.Integer)
    ...
    def __init__(self, sup_code, sup_name, sup_jpem, sup_ppn, sup_npwp,
    sup_address, sup_kota, sup_kpos, sup_telp1,sup_telp2, sup_fax, sup_cp, sup_curren,
    sup_ket, sup_hutang, sup_uang_muka, sup_limit):
